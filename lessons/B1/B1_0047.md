...
- Students will be able to discuss comparing options using appropriate vocabulary
...
**Description:** Students think about their experiences with comparing options, discuss with a partner, then share with the class
...
1. What do you think about comparing options?
2. Can you describe your experience with comparing options?
3. How important is comparing options in your life?
4. What are the advantages of comparing options?
5. Have you ever had a problem with comparing options?
6. Would you recommend comparing options to others? Why?
7. How has comparing options changed over time?
8. What would you like to learn about comparing options?
...
### Scenario 1: At a comparing options event
...
### Scenario 2: Planning related to comparing options
...
- Watch a video about comparing options and summarize the main points
- Write a blog post about your opinion on comparing options
- Interview someone about their experience with comparing options

---

## Homework Assignment

**Task:** Prepare a 2-3 minute presentation about comparing options
...
Review key vocabulary and concepts related to comparing options
...
Be aware of cultural sensitivities related to comparing options
